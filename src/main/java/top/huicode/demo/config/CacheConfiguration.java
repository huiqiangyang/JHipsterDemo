...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(top.huicode.demo.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(top.huicode.demo.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
