...
import top.huicode.demo.repository.EmployeeRepository;
...
public class EmployeeResource {
    ...
    @Timed
    public List<Employee> findAllByFirstName(@RequestParam("firstName") String firstName) {
        log.debug("REST request to get all Employees by findAllByFirstName");
